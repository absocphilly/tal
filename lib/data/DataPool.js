...
module.exports = d => {
	...
	class DataPool {
		...
		constructor(token, options) {
			...
			this._poolCache      = new Array(this.poolSize);
			this._pooli          = 0;
		}
